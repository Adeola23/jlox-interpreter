...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void>{
    ...
    //To evaluate a grouping expression itself,
    ...
    //Lox uses double-precision numbers even for integer values. In that case,
    //they should print without a decimal point.
